...
GeonetSDK._make_feature = _make_feature


function GeonetSDK.new(options)
  local self = setmetatable({}, GeonetSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GeonetSDK:options_map()
...
function GeonetSDK:get_utility()
  return Utility.copy(self._utility)
end


function GeonetSDK:get_root_ctx()
  return self._rootctx
end


function GeonetSDK:prepare(fetchargs)
...
function GeonetSDK:direct(fetchargs)
...
-- by passing it.
function GeonetSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GeonetSDK:graphql(query, variables, ctrl)
...
function GeonetSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = GeonetSDK.new(sdkopts)
  sdk.mode = "test"
