...
describe("DnsDirect", function()
  it("should direct-load-dns", function()
    local setup = dns_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dns", setup.live and "live" or "unit")
...
function dns_direct_setup(mockres)
