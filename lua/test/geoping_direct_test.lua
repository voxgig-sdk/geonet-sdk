...
describe("GeopingDirect", function()
  it("should direct-load-geoping", function()
    local setup = geoping_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-geoping", setup.live and "live" or "unit")
...
function geoping_direct_setup(mockres)
