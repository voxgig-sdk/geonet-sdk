...
describe("PingDirect", function()
  it("should direct-load-ping", function()
    local setup = ping_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ping", setup.live and "live" or "unit")
...
function ping_direct_setup(mockres)
