...
describe("GeodnDirect", function()
  it("should direct-load-geodn", function()
    local setup = geodn_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-geodn", setup.live and "live" or "unit")
...
function geodn_direct_setup(mockres)
