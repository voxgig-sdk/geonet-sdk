...
class GeonetTestRunner
{
    ...
    {
        $live = self::getenv('GEONET_TEST_LIVE');
        $override = self::getenv('GEONET_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GEONET_TEST_EXPLAIN');
...
class_alias('GeonetTestRunner', 'Runner');
class_alias('GeonetHelpers', 'Helpers');
