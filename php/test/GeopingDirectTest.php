...
class GeopingDirectTest extends TestCase
{
    public function test_direct_load_geoping(): void
    {
        $setup = geoping_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-geoping", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
