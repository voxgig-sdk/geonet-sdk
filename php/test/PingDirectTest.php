...
class PingDirectTest extends TestCase
{
    public function test_direct_load_ping(): void
    {
        $setup = ping_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ping", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
