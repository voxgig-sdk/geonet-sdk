...
// Geonet SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GeonetSDK::test)
...
{
    private const SDK_CLASS = 'GeonetSDK';
    ...
    private const SDK_BASE = 'geonet_sdk';
