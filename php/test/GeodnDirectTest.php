...
class GeodnDirectTest extends TestCase
{
    public function test_direct_load_geodn(): void
    {
        $setup = geodn_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-geodn", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
