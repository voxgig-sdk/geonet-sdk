...
class DnsDirectTest extends TestCase
{
    public function test_direct_load_dns(): void
    {
        $setup = dns_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-dns", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
