...
class GeonetFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GeonetSDK/1.0)';
    ...
    public static function call(GeonetContext $ctx, string $fullurl, array $fetchdef): array
    {
