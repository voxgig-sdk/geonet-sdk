...
class GeonetSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = GeonetHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = GeonetHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!GeonetFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, GeonetFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return GeonetUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = GeonetHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = GeonetHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = GeonetHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new GeonetError($op . "_allow",
                "GeonetSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = GeonetHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new GeonetError("graphql_error",
                "GeonetSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Geodn($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_geodn === null) {
                $this->_geodn = new GeodnEntity($this, null);
            }
            return $this->_geodn;
        }
        return new GeodnEntity($this, $data);
    }
    ...
    public function Geoping($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_geoping === null) {
                $this->_geoping = new GeopingEntity($this, null);
            }
            return $this->_geoping;
        }
        return new GeopingEntity($this, $data);
    }
