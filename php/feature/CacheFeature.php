...
class GeonetCacheFeature extends GeonetBaseFeature
{
    ...
    private function _through(GeonetContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
