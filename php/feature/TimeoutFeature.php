...
class GeonetTimeoutFeature extends GeonetBaseFeature
{
    ...
    private function _with_timeout(GeonetContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GeonetContext $_ctx, float $ms): void
    {
        $client = $this->client;
