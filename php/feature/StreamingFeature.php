...
class GeonetStreamingFeature extends GeonetBaseFeature
{
    ...
    private function _iterate(GeonetResult $result): \Generator
    {
    ...
    private function _streamable(GeonetContext $ctx): bool
    {
