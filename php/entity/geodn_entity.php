...
class GeodnEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GeodnEntity($this->_client, $opts);
    }

    /**
     * @param Geodn|array $args Geodn data (assoc-array) to store.
     */
    ...
    /**
     * @return Geodn|array The current Geodn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Geodn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Geodn fields).
     */
     ...
     * Load a single Geodn.
     *
     * @param GeodnLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GeodnLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Geodn|array The loaded Geodn as an assoc-array at the
