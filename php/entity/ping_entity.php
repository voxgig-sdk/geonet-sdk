...
class PingEntity
{
     ...
     * Load a single Ping.
     *
     * @param PingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ping|array The loaded Ping as an assoc-array at the
