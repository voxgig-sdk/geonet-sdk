...
class DnsEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DnsEntity($this->_client, $opts);
    }

    /**
     * @param Dns|array $args Dns data (assoc-array) to store.
     */
    ...
    /**
     * @return Dns|array The current Dns data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dns fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dns fields).
     */
     ...
     * Load a single Dns.
     *
     * @param DnsLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DnsLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dns|array The loaded Dns as an assoc-array at the
