...
from geonet_sdk.core.helpers import get_ctx_prop, to_map
...
class GeonetContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, GeonetResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GeonetError(code, msg, self)
