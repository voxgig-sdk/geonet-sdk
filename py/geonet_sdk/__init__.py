...
from geonet_sdk.utility import register

# Load features
from geonet_sdk.feature.base_feature import GeonetBaseFeature
from geonet_sdk.features import _has_feature, _make_feature
...
class GeonetSDK:
    ...
    def get_utility(self):
        return GeonetUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GeonetSDK: graphql: " + str(msg))
            res["graphql"] = errors
