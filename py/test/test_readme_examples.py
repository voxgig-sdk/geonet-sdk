# Geonet SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GeonetSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GeonetSDK(...) and GeonetSDK.test(...) become
#      GeonetSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "geonet_sdk"
_SDK_CLASS = "GeonetSDK"
