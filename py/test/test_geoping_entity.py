...
class TestGeopingEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        geoping_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(geoping_ref01_data_dt0_loaded))
        assert geoping_ref01_data_dt0_load_result is not None
        assert geoping_ref01_data_dt0_load_result["id"] == geoping_ref01_data["id"]
