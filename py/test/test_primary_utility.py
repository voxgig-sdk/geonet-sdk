...
from geonet_sdk.core.spec import GeonetSpec
from geonet_sdk.core.result import GeonetResult
from geonet_sdk.core.response import GeonetResponse
from geonet_sdk.core.operation import GeonetOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = GeonetSDK.test(None, None)
        ...
        class TestInitFeature(GeonetBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GeonetBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GeonetSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GeonetSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GeonetSDK.test(None, setup_opts)
