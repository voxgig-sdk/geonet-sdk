...
class PingEntity
  ...
  # Load a single Ping.
  #
  # @param reqmatch [PingLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Ping.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Ping, Hash] the loaded Ping; raises GeonetError on failure
