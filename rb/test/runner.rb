...
module GeonetTestRunner
  ...
  def self.env_override(m)
    live = getenv("GEONET_TEST_LIVE")
    override = getenv("GEONET_TEST_OVERRIDE")
    ...
    explain = getenv("GEONET_TEST_EXPLAIN")
    m["GEONET_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = GeonetTestRunner
Helpers = GeonetHelpers
Vs = VoxgigStruct
