...
type Args struct {
	Entity string         `json:"entity" jsonschema:"dns | geodn | geoping | ping"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GeonetSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "geonet_list",
		Description: "List records from Geonet. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "geonet_load",
		Description: "Load a single record from Geonet. " +
...
func runOp(client *sdk.GeonetSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GeonetSDK, name string) (sdk.GeonetEntity, error) {
	switch strings.ToLower(name) {
	case "dns":
		return client.Dns(nil), nil
	case "geodn":
		return client.Geodn(nil), nil
	case "geoping":
		return client.Geoping(nil), nil
	case "ping":
