...
describe('PingDirect', async () => {
  ...
  test('direct-load-ping', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-ping', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GEONET_TEST_PING_ENTID']
