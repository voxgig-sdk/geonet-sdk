...
describe('GeopingDirect', async () => {
  ...
  test('direct-load-geoping', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-geoping', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GEONET_TEST_GEOPING_ENTID']
