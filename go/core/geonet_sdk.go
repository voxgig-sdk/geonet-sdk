...
func (sdk *GeonetSDK) OptionsMap() map[string]any {
...
func (sdk *GeonetSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GeonetSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GeonetSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GeonetSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GeonetSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GeonetSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GeonetSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GeonetSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GeonetSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GeonetSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
