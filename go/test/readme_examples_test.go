...
const testSeed = `map[string]any{"entity": map[string]any{"dns": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "geodn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "geoping": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ping": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
