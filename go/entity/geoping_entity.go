...
import (
	...
	vs "github.com/voxgig-sdk/geonet-sdk/go/utility/struct"
)

type GeopingEntity struct {
	name    string
	client  *core.GeonetSDK
...
func NewGeopingEntity(client *core.GeonetSDK, entopts map[string]any) *GeopingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GeopingEntity) GetName() string { return e.name }
...
func (e *GeopingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GeopingEntity) Deleted() bool {
	return e.deleted
}


func (e *GeopingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGeopingEntity(e.client, opts)
}

func (e *GeopingEntity) Data(args ...any) any {
...
func (e *GeopingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Geoping; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GeopingEntity) DataTyped(data ...Geoping) Geoping {
	if len(data) > 0 {
		return typedFrom[Geoping](e.Data(asMap(data[0])))
	}
	return typedFrom[Geoping](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Geoping (all fields
// optional at the wire level).
func (e *GeopingEntity) MatchTyped(match ...Geoping) Geoping {
	if len(match) > 0 {
		return typedFrom[Geoping](e.Match(asMap(match[0])))
	}
	return typedFrom[Geoping](e.Match())
}
...
func (e *GeopingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GeopingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GeopingLoadMatch and returns an Geoping. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GeopingEntity) LoadTyped(reqmatch GeopingLoadMatch, ctrl map[string]any) (Geoping, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Geoping{}, err
	}
	return typedFrom[Geoping](res), nil
}



func (e *GeopingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GeopingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GeopingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GeopingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GeopingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
