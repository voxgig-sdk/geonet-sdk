...
func NewDnsEntity(client *core.GeonetSDK, entopts map[string]any) *DnsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DnsEntity) GetName() string { return e.name }
...
func (e *DnsEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DnsEntity) Deleted() bool {
	return e.deleted
}


func (e *DnsEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDnsEntity(e.client, opts)
}

func (e *DnsEntity) Data(args ...any) any {
...
func (e *DnsEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DnsEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DnsEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DnsEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DnsEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DnsEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DnsEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
