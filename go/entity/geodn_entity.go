...
func NewGeodnEntity(client *core.GeonetSDK, entopts map[string]any) *GeodnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GeodnEntity) GetName() string { return e.name }
...
func (e *GeodnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GeodnEntity) Deleted() bool {
	return e.deleted
}


func (e *GeodnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGeodnEntity(e.client, opts)
}

func (e *GeodnEntity) Data(args ...any) any {
...
func (e *GeodnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Geodn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GeodnEntity) DataTyped(data ...Geodn) Geodn {
	if len(data) > 0 {
		return typedFrom[Geodn](e.Data(asMap(data[0])))
	}
	return typedFrom[Geodn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Geodn (all fields
// optional at the wire level).
func (e *GeodnEntity) MatchTyped(match ...Geodn) Geodn {
	if len(match) > 0 {
		return typedFrom[Geodn](e.Match(asMap(match[0])))
	}
	return typedFrom[Geodn](e.Match())
}
...
func (e *GeodnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GeodnEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GeodnLoadMatch and returns an Geodn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GeodnEntity) LoadTyped(reqmatch GeodnLoadMatch, ctrl map[string]any) (Geodn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Geodn{}, err
	}
	return typedFrom[Geodn](res), nil
}



func (e *GeodnEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GeodnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GeodnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GeodnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GeodnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
