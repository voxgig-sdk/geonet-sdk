...
The Golang SDK for the Geonet API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/geonet-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/geonet-sdk=../path/to/github.com/voxgig-sdk/geonet-sdk
```
...
```
github.com/voxgig-sdk/geonet-sdk/
...
The root package (`github.com/voxgig-sdk/geonet-sdk`) re-exports everything needed
