...
Run various network tools from multiple geographic locations

Learn more about Geonet at [geonet.shodan.io](https://geonet.shodan.io).
...
This SDK exposes the API as a small set of **semantic entities** — Dns, Geodn, Geoping and Ping — that you
