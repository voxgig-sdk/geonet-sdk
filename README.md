...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/geonet` | `npm install @voxgig-sdk/geonet` |
| Python | `voxgig-sdk-geonet` | `pip install voxgig-sdk-geonet` |
| PHP | `voxgig-sdk/geonet` | `composer require voxgig-sdk/geonet` |
| Golang | `github.com/voxgig-sdk/geonet-sdk/go` | `go get github.com/voxgig-sdk/geonet-sdk/go` |
| Ruby | `voxgig-sdk-geonet` | `gem install voxgig-sdk-geonet` |
| Lua | `voxgig-sdk-geonet` | `luarocks install voxgig-sdk-geonet` |
