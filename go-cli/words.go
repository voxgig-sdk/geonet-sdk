...
func registerSDKWords(r *eng.Registry, client *sdk.GeonetSDK) {
...
func runOp(client *sdk.GeonetSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
