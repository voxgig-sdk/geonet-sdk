...
class GeonetTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GeonetTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = GeonetTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = GeonetTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
