...
class GeonetTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GeonetTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GeonetTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GeonetTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
