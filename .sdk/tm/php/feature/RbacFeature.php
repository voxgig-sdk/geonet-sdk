...
class GeonetRbacFeature extends GeonetBaseFeature
{
    ...
    private function _required(GeonetContext $ctx): ?string
    {
    ...
    private function _reject(GeonetContext $ctx, string $required): void
    {
    ...
    private function _track(GeonetContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
