...
// Geonet SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GeonetTestFeature extends GeonetBaseFeature
{
    ...
    public function init(GeonetContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GeonetContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GeonetContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GeonetContext $ctx, $op, $args): array
    {
