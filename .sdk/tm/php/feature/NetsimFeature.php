...
class GeonetNetsimFeature extends GeonetBaseFeature
{
    ...
    private function _simulate(GeonetContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GeonetContext $ctx, array $applied): void
    {
        $client = $this->client;
