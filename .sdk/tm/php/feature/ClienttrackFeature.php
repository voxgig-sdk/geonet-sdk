...
// Geonet SDK clienttrack feature
...
class GeonetClienttrackFeature extends GeonetBaseFeature
{
    ...
    public function PostConstruct(GeonetContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Geonet-SDK';
