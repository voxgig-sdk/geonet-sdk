...
class GeonetProxyFeature extends GeonetBaseFeature
{
    ...
    public function init(GeonetContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GeonetContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
