...
class GeonetRatelimitFeature extends GeonetBaseFeature
{
    ...
    private function _acquire(GeonetContext $ctx): void
    {
    ...
    private function _track(GeonetContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
