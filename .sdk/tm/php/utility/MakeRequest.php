...
// Geonet SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GeonetMakeRequest
{
    public static function call(GeonetContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GeonetResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GeonetResponse($fetched);
        } else {
